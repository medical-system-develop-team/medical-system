...
export default {
  ...
  data() {
    return {
      ...
      preActiveIndex: '0',
      menus: [
        { label: '首页', key: 'home', path: '/staffhome', class: 'main-menu', icon: 'el-icon-s-home' },
        { label: '退出系统', key: 'logout', path: '/', class: 'right-menu' },
        { label: '我的个人信息', key: 'personInfo', path: '/staffmyInfo', class: 'right-menu' },
        { label: '我的报销记录', key: 'records', path: '/staffmyRecords', class: 'right-menu' },
        { label: '录入报销凭证', key: 'inVoucher', path: '/staffuploadVoucher', class: 'right-menu' }
      ]
    }
  },
  created() {
